...
try:
    ...
    modelName = argv.index("--") + 7
    shotName = argv.index("--") + 9
...
bpy.ops.wm.save_as_mainfile(filepath="E:\\GeradWebServer\\GeradWebServer\\SuitProcess\\Fabrics\\" + modelName + "\\" + shotName + ".blend")
